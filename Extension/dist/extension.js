...
const modelConnection_1 = __webpack_require__(4);
function activate(context) {
    ...
    let disposable3 = vscode.commands.registerCommand('ai-reviewer.modelConnection', async (userPrompt) => {
        try {
            const modelResponse = await (0, modelConnection_1.sendMessageToModel)(userPrompt);
...
var CombinedStream = __webpack_require__(7);
...
var asynckit = __webpack_require__(19);
var populate = __webpack_require__(29);
...
var util = __webpack_require__(8);
var Stream = (__webpack_require__(9).Stream);
var DelayedStream = __webpack_require__(10);
...
module.exports =
{
  parallel      : __webpack_require__(20),
...
var iterate    = __webpack_require__(21)
  , initState  = __webpack_require__(25)
  , terminator = __webpack_require__(26)
  ;
...
var abort = __webpack_require__(24)
